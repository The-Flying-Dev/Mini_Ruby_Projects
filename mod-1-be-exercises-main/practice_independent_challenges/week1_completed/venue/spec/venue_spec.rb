...
describe Venue do
  ...
  describe '#over_capacity?' do 
    it 'determines if venue has exceeded capacity' do 
  ...
  describe '#kick_out' do
    it 'removes people from the patrons list until its reached capacity'
    ...
    #expect(venue.kick_out).to recieve(:over_capacity?)
  end
