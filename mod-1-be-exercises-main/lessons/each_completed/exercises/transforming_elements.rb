...
# 1. What do you think the output will be on line 14? # => The original names Collection
# 2. Now run it in your terminal.
# 3. Was the output what you thought it would be? # => Yes 
...
# our new array with names capitalized?  # => To the new Collection
